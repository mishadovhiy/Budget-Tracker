...
//  Budget Tracker
//
//  Created by Misha Dovhiy on 23.04.2022.
...
extension AppDelegate:GADBannerViewDelegate {
    ...
    func addBannerViewToView(_ bannerView: GADBannerView) {
        DispatchQueue.main.async {
            ...
            self.bannerBacgroundView = backgroundV
            ...
            closeButton.target(forAction: #selector(self.closeBannerPressed), withSender: self)
            closeButton.addTarget(self, action: #selector(self.closeBannerPressed), for: .touchUpInside)
