        ...
        load.Users { (loadedData, error) in
            if error {
                ...
                self.tableData = [
                    ...
                    tableStruct(name: "Web purchase", value: loadedResult[4] == "0" ? "Yes": "No", needIndicator: false, action: self.breakAction),
                    ...
                    tableStruct(name: "Log out", value: "", needIndicator: true, action: logoutAction)
                ]
                DispatchQueue.main.async {
