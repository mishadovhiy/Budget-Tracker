...
struct localizationDictUA {
    ...
    static let dictUA: [String:String] = [
        ...
        "Set repeated or one time reminders. Easy as adding new transaction": "Встановлюйте одноразовi або повторнi нагадування. Легко як додати нову транзакцiю",
        "Set 4 digit passcode": "4-значний пароль",
